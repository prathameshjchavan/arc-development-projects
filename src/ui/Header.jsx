...
function Header() {
	...
	const logo = (
		<svg
			...
			viewBox="0 0 480 139"
		>
			<style>{`.st0{fill:none}.st1{fill:#fff}.st2{font-family:Raleway;text-transform:none;text-decoration:none;font-weight:100;}.st6{fill:none;stroke:#000;stroke-width:3;stroke-miterlimit:10}`}</style>
